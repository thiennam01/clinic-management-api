...
@section('title', 'Chỉnh sửa chuyên khoa')
...
<div class="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-slate-500">
            Cập nhật thông tin chuyên khoa {{ $specialty->code }}
        </p>
    ...
    <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <form
            method="POST"
            action="{{ route('web.specialties.update', $specialty->id) }}"
            class="space-y-6"
        >
            ...
            <div>
                ...
                <input
                    ...
                    disabled
                    class="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-500"
                >

                <p class="mt-1 text-xs text-slate-400">
                    Mã được hệ thống tự động sinh và không thể chỉnh sửa.
                </p>
